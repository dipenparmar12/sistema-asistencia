...
__decorate([
    typeorm_1.ManyToOne(type => Teacher_1.default, { onDelete: "SET NULL" }),
    __metadata("design:type", Teacher_1.default)
], Student.prototype, "teacher", void 0);
__decorate([
    typeorm_1.OneToMany(type => Attendance_1.default, attendance => attendance.student, { onDelete: "SET NULL" }),
