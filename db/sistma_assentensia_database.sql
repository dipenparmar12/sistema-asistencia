...
--
-- Host: localhost:3306
-- Generation Time: Jan 27, 2021 at 06:35 PM
...
--
ALTER TABLE `attendance`
  ADD CONSTRAINT `FK_120e1c6edcec4f8221f467c8039` FOREIGN KEY (`studentId`) REFERENCES `student` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `student`
--
ALTER TABLE `student`
  ADD CONSTRAINT `FK_f4481746c56ffa6cf77829a4bcc` FOREIGN KEY (`teacherId`) REFERENCES `teacher` (`id`) ON DELETE SET NULL;
COMMIT;
